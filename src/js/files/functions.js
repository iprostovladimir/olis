...
export function tabs() {
  ...
  tabTitles.forEach((tabTitle) => {
    tabTitle.style.transition = "all 0.3s ease";

    const nextElement = tabTitle.nextElementSibling;
    if (nextElement) {
...
export function menuInit() {
  ...
  if (iconMenu) {
    iconMenu.addEventListener("click", function (e) {
      document
        .querySelector(`[data-selector='catalog-sublist']`)
        .classList.remove("_active");
      document
        .querySelector(`[data-hassub='catalog-sublist']`)
        .classList.remove("_active");
