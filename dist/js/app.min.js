...
// EXTERNAL MODULE: ./node_modules/js-image-zoom/js-image-zoom.js
var js_image_zoom = __webpack_require__(920);
...
const inner = document.querySelector(".header-sublist");
...
// EXTERNAL MODULE: ./node_modules/inputmask/dist/inputmask.min.js
var inputmask_min = __webpack_require__(125);
;// CONCATENATED MODULE: ./src/js/files/forms/inputmask.js
...
;// CONCATENATED MODULE: ./src/js/libs/wNumb.min.js
...
function dom7_esm_hasClass(...classes) {
  const classNames = arrayFlat(classes.map(c => c.split(' ')));
...
function initSliders() {
  ...
  if (document.querySelector(".swiper")) {
    const sliderInfo = new core(".js-info-slider", {
    ...
    const sliderReviews = new core(".js-slider-reviews", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const sliderReviewsTwo = new core(".js-slider-reviewsTwo", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const sliderPopular = new core(".js-slider-popular", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const sliderThumbs = new core(".js-slider-thumbs", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const sliderGallery = new core(".js-slider-gallery", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, Thumb, A11y],
      /*
			effect: 'fade',
			autoplay: {
				delay: 3000,
    ...
    const sliderThumbsCards = new core(".js-slider-thumbscards", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const sliderGalleryCards = new core(".js-slider-gallerycards", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, Thumb, EffectFade, A11y],
      effect: "fade",
      // autoplay: {
      // 	delay: 3000,
      // 	disableOnInteraction: false,
    ...
    const kitThumbs = new core(".js-thumbslider-kit", {
      // Подключаем модули слайдера
      // для конкретного случая
    ...
    const kitGallery = new core(".js-slider-kit", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, Thumb],
      /*
    ...
    const sliderProject = new core(".js-slider-project", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
    ...
    const kitThumbsVideo = new core(".js-thumbslidervideo-kit", {
      // Подключаем модули слайдера
      // для конкретного случая
    ...
    const kitGalleryVideo = new core(".js-slidervideo-kit", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, Thumb, A11y],
      /*
    ...
    const sliderColumn = new core(".js-slider-column", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, A11y],
      /*
...
;// CONCATENATED MODULE: ./src/js/files/scroll/lazyload.js
